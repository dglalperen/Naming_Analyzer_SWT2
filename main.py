    ...
    for index, row in repositories_df.iterrows():
        ...
        try:
            if check_github_api_credentials(GITHUB_API_URL, github_token):
                ...
                print('der Score für das das Repo: ' + repo_url + ' ist: ' + str(score))
                repositories_df.at[index, 'Semantic Rating'] = score['semantic_score']
                repositories_df.at[index, 'Syntactic Rating'] = score['syntactic_score']
                # delete repository
